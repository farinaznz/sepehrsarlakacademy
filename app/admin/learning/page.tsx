...
export default async function LearningAdminPage() {
  ...
  const [lessons, pendingComments, users, instructors, courses] = await Promise.all([
    db.select({ id: lesson.id, courseId: lesson.courseId, slug: lesson.slug, title: lesson.title, summary: lesson.summary, content: lesson.content, position: lesson.position, sectionTitle: lesson.sectionTitle, courseTitle: course.title, published: lesson.published, dripDelayDays: lesson.dripDelayDays })
